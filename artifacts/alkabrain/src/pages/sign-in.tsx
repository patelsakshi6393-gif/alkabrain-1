    ...
    <div className="min-h-screen bg-gradient-to-br from-accent via-background to-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Sign in to your ALKABRAIN account</p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-4">
          ...
          <Link href="/sign-up" className="text-primary hover:underline font-medium">Sign up free</Link>
        </p>
