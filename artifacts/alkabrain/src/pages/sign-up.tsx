...
export default function SignUp() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      const msg = (err as { message?: string })?.message || "Google sign up failed";
    ...
    <div className="min-h-screen bg-gradient-to-br from-accent via-background to-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Start boosting your business today — 100 free credits!</p>
        </div>
