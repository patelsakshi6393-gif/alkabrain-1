...
export default function SignUp() {
  ...
  async function handleEmail(e: React.FormEvent) {
    ...
    try {
      ...
      const msg = err.code === 'auth/email-already-in-use' ? 'This email is already registered. Sign in instead.' :
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-lg border">
        ...
        <form onSubmit={handleEmail} className="space-y-4">
          <div>
            ...
            <Input value={name} onChange={e => setName(e.target.value)} className="mt-1" placeholder="Rahul Sharma" />
          </div>
          <div>
            <Label>Email</Label>
          ...
          <div>
            ...
            <Input type="password" value={password} onChange={e => setPassword(e.target.value)} required className="mt-1" placeholder="Min 6 characters" minLength={6} />
          </div>
